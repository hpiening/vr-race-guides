        ...
        <div className="mb-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {data.hikes.map((hike, i) => (
              ...
              >
                <p className="font-heading text-base uppercase mb-3 group-hover:text-vr-floral transition-colors">
                  {hike.name}
                </p>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {data.restaurants.map((r, i) => (
              <a
                ...
                className="border border-vr-forest/10 rounded-lg p-5 hover:border-vr-forest/30 transition-colors group"
              >
                <p className="font-heading text-base uppercase mb-2 group-hover:text-vr-floral transition-colors">
                  {r.name}
                </p>
