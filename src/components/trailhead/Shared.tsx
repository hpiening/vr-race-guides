...
export const CARD_ICONS: Record<CardIcon, string> = {
  ...
  palette:  'M12 21a9 9 0 110-18c5 0 9 3.5 9 7.9 0 2.4-2 4.4-4.4 4.4H15a2 2 0 00-1.4 3.4A1.8 1.8 0 0112 21zM7.6 9.6v.01M10.2 6.7v.01M14.6 6.9v.01M17.2 9.9v.01',
  hat:      'M5 17.5h14M7.5 17.5V6.5h9v11M7.5 6.5h9M7.5 12.5h9',
}
